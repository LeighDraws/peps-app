package com.project.peps.recipehasingredient.model;
...
@Table(name = "recipe_has_ingredient", uniqueConstraints = { @UniqueConstraint(columnNames = { "recipe_id", "ingredient_id" }) })
