...
@Mapper(componentModel = "spring", uses = {UserMapper.class, CountryMapper.class}, unmappedTargetPolicy = ReportingPolicy.IGNORE)
public interface RecipeMapper {
    ...
    @Mapping(source = "countryId", target = "country.id")
    @Mapping(source = "userId", target = "user.id")
    void updateEntityFromRequest(RecipeRequest request, @MappingTarget Recipe entity);
